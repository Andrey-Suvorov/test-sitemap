<?php
    Route::group(['namespace' => 'Hantu\Sitemap\Http\controllers', 'middleware' => config('sitemap.route_middleware'), 'prefix' => config('sitemap.route_prefix'), 'as' => config('sitemap.route_as')], function () {
